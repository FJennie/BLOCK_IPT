...
RUN_LOG="$LOG_DIR/h2o_631g_cas10e10o_fci_63504_primme_vs_ipt_${SLURM_JOB_ID:-manual}.log"
ln -sfn "$RUN_LOG" "$LOG_DIR/latest_h2o_631g_cas10e10o_fci_63504_primme_vs_ipt.log"
...
export IPT_MAXITER="${IPT_MAXITER:-500}"
...
echo "===== H2O/6-31G CAS(10e,10o) PRIMME vs IPT sparse benchmark ====="
date
hostname
...
nvcc -O3 -std=c++14 -lineinfo -arch=sm_80 \
    ...
    "$TEST_DIR/benchmark_h2o_631g_cas10e10o_primme_vs_ipt.cu" \
    "$PRIMME_ROOT/lib/libprimme.a" \
    -o "$TEST_DIR/benchmark_h2o_631g_cas10e10o_primme_vs_ipt_cuda" \
...
echo
echo "===== run ====="
"$TEST_DIR/benchmark_h2o_631g_cas10e10o_primme_vs_ipt_cuda"
status=$?
