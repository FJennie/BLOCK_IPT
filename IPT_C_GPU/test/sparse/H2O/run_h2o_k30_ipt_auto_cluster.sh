...
export IPT_MAX_LIFT_BLOCK_SIZE="${IPT_MAX_LIFT_BLOCK_SIZE:-256}"
export IPT_BLOCK_CLUSTER_FALLBACK_IDENTITY="${IPT_BLOCK_CLUSTER_FALLBACK_IDENTITY:-1}"
...
echo "IPT_MAX_LIFT_BLOCK_SIZE=$IPT_MAX_LIFT_BLOCK_SIZE"
echo "IPT_BLOCK_CLUSTER_FALLBACK_IDENTITY=$IPT_BLOCK_CLUSTER_FALLBACK_IDENTITY"
...
echo "===== output files ====="
ls -lh "$TEST_DIR" "$LOG_DIR" "$RESULTS_DIR" || true
